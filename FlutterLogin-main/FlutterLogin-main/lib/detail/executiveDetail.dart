...
class ExecutiveDetail extends StatefulWidget {
  const ExecutiveDetail({Key? key}) : super(key: key);

  @override
  State<ExecutiveDetail> createState() => _ExecutiveDetailState();
}

class _ExecutiveDetailState extends State<ExecutiveDetail> {
  ...
  final List<String> imgList = [
    "img/room_img/Executive.PNG",
    "img/executiveDetail/detailexe1.jpg",
    "img/executiveDetail/detailexe2.jpg",
  ];
