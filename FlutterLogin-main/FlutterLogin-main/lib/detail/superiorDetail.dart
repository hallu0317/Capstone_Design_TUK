...
class SuperiorDetail extends StatefulWidget {
  const SuperiorDetail({Key? key}) : super(key: key);

  @override
  State<SuperiorDetail> createState() => _SuperiorDetailState();
}

class _SuperiorDetailState extends State<SuperiorDetail> {
  ...
  final List<String> imgList = [
    "img/superiorDetail/detailsup1.jpg",
    "img/superiorDetail/detailsup2.jpg",
    "img/room_img/Suite.PNG"
  ];
